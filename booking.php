...
<form class="ui form attached fluid loading segment" onsubmit="return contact(this)">
 ...
 <div class="field">
    <select required id="destination">
      ...
      <option>NEW DELHI to MUMBAI</option>
      <option>MUMBAI to NEW DELHI</option>
	   <option>KOLKATA to GHAZIABAD</option>
	    <option>GHAZIABAD to KOLKATA</option>
    </select>
  </div>   
  </div>
<div class="field">  
...
<label>Payment</label>  
    <select name="gender" required id="paymentmethod">
      ...
      <option value="SBI_BANK">SBI</option>
